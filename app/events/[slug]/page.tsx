        ...
        <article className="overflow-hidden border border-black bg-white">
          <div className="grid md:grid-cols-2 md:items-start">
            ...
            <div className="min-w-0 flex flex-col gap-7 p-5 sm:p-7 md:p-9">
              ...
              <h1 className="min-w-0 max-w-full overflow-hidden text-2xl font-medium leading-tight tracking-normal md:text-3xl lg:text-5xl break-words [overflow-wrap:anywhere]">{show.title}</h1>
