  ...
  return (
    <main className="public-shell min-h-svh bg-[#f3ead9] text-zinc-950">
      ...
      <div className="w-full max-w-lg rounded-2xl border border-border bg-[#fbf7ec] p-8 text-center shadow-lg">
        ...
        <h1 className="mt-5 text-4xl font-semibold tracking-tight">Betalingen ble avbrutt.</h1>
        <p className="mt-2 font-medium text-zinc-700">Du kan gå tilbake til eventet og prøve igjen.</p>
        <div className="mt-7 flex justify-center gap-2">
          <Button asChild className="rounded-full bg-[#b83224] font-semibold text-white transition hover:bg-[#9f2d21]"><Link href={eventHref}>Tilbake til eventet</Link></Button>
          <Button asChild variant="outline" className="rounded-full border border-border bg-transparent font-semibold transition hover:bg-zinc-950 hover:text-white"><Link href={clubHomeHref}>Tilbake til klubben</Link></Button>
        </div>
      </div>
      </section>
    </main>
